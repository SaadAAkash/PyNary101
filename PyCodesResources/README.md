Number thoery, Algorithm, Data Sturcutre, Graphs, Text, Networking, Multi Threading, Web, Files & DB, Security, Graphics basic to Intermediate codes in Python
=========================================

These are basically the solutions of [Projects](http://nbviewer.ipython.org/github/jmportilla/Complete-Python-Bootcamp/blob/master/Final%20Capstone%20Projects/Final%20Capstone%20Project%20Ideas.ipynb) written by other users in Python.
--------
